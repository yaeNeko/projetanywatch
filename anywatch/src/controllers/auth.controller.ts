...
export const signup = async (
  ...
  try {
    ...
    const result = await client.query(
      "INSERT INTO utilisateurs (pseudo, email, mot_de_passe, est_public) VALUES ($1, $2, $3, $4) RETURNING id, pseudo, email",
      [username, email, hashedPassword, true] // ou false si nécessaire
    );
